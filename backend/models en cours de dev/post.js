...
Post.associate = function(models){models.Post.belongsTo(models.Users,{foreignKey:{alllowNull: false}}); };
Post.associate = function(models){models.Post.belongsTo(models.Categories,{foreignkey:{allowNull: false}}); };
